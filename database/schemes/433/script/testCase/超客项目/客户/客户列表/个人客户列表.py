...
class EasyCase(TestCase):
	...
	def runTest(self):
		...
		driver.find_element_by_link_text("个人客户列表").click()  # 点击个人客户表
		...
		driver.find_element_by_css_selector("#root > div > div > div.QueryDataTable > div > div > div:nth-child(2) > div > div > div.ant-spin-container > div > div > div > span > div > table > tbody > tr > td.ant-table-selection-column > span > label > span > input").click()  # 选择客户
		driver.find_element_by_css_selector("#root > div > div > div.ck-root-title > div > div.ant-col-10.ant-col-offset-6 > div.cklist-PersonChange > button > span").click()  # 变更负责人
		driver.find_element_by_css_selector('body > div:nth-child(8) > div > div.ant-modal-wrap > div > div.ant-modal-content > div.ant-modal-body > div:nth-child(2) > div > div > ul > li:nth-child(1)').click()  # 选择蒋启龙
		...
		sleep(3)
		driver.find_element_by_css_selector("#root > div > div > div.ant-tabs.ant-tabs-top.ant-tabs-card > div.ant-tabs-bar > div > div > div > div > div:nth-child(3) > div").click()  # 点击负责的客户
		driver.find_element_by_css_selector('#root > div > div > div.QueryDataTable > div > div > div:nth-child(2) > div > div > div.ant-spin-container > div > div > div > span > div > table > tbody > tr > td.ant-table-selection-column > span > label > span > input').click()  # 勾选客户
		driver.find_element_by_css_selector("#root > div > div > div.ck-root-title > div > div.ant-col-10.ant-col-offset-6 > div.cklist-PersonChange > button > span").click()  # 变更负责人
