...
def compress_image(im,outFileName, width=800, height=600):
    '''
    缩略图
    '''
...
#等比例压缩图片
def resizeImg(im,outFileName, dst_w=0, dst_h=0, qua=85):
    '''
    ...
    im.resize((newWidth,newHeight),Image.ANTIALIAS).save(outFileName, "JPEG", quality=qua)
    # print(u'等比压缩完成')
