...
class EasyCase(TestCase):
	...
	def runTest(self):
		...
		WW = driver.find_element_by_css_selector("body > div.container.corp-page.ng-scope > div > div.col-xs-10.corp-content > div.row.space20.ng-scope > div.col-xs-12 > table > tbody > tr:nth-child(8) > td:nth-child(2) > span").text
