...
class EasyCase(TestCase):
	...
	def runTest(self):
		...
		driver.find_element_by_xpath('//*[@id="pStartDate"]','开始时间').send_keys('2016-12-31 00:00:00')#输入开始时间
		driver.find_element_by_xpath('//*[@id="pEndDate"]','结束时间').send_keys('2018-09-30 00:00:00')#输入结束时间
		...
		#断言
		QW=driver.find_elements_by_xpath('//span[@ng-bind="postActivity.pName"]')[-1].text
