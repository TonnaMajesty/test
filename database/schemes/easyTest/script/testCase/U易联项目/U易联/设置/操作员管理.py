...
class EasyCase(TestCase):
	...
	def runTest(self):
		...
		time.sleep(1)
		s6 = tool.randomStr(8)
		driver.find_element_by_id("cPhone").send_keys("152"+s6)
		time.sleep(1)
		...
		# 新增验证
		new = driver.find_element_by_css_selector("#datagrid > tbody > tr > td:nth-child(2) > span","findAssert").text
		self.assertEqual(new, s1+'@yycc', '新增失败')
		...
		s8 = tool.randomStr(8)
		driver.find_element_by_id("cPhone").send_keys("152"+s8)
		time.sleep(1)
		driver.find_element_by_id('saveAction').click()
		...
		driver.find_element_by_id("btnDialogBySHFConfirm").click()
		# 删除验证
		delete = driver.find_element_by_css_selector("#datagrid > tbody > tr > td:nth-child(2) > span","findAssert").text
		self.assertNotEqual(delete, s3+'@yycc', "删除成功")
		...
		time.sleep(1)
		driver.find_element_by_id("query_cPhone").send_keys("152"+s8)
		time.sleep(1)
		...
		search = driver.find_element_by_css_selector(
			"#datagrid > tbody > tr > td:nth-child(2) > span","findAssert").text
		self.assertEqual(search, s3+'@yycc', "查询成功")