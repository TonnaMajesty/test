...
class EasyCase(TestCase):
	...
	def runTest(self):
		...
		driver.find_element_by_id("dStartTime").send_keys("2016-11-21 09:07")
		time.sleep(1)

		driver.find_element_by_id("dEndTime").send_keys("2017-08-15 09:07")
		time.sleep(1)
		...
		time.sleep(5)
		# 新增/复制验证
		new = driver.find_element_by_css_selector("#datagrid > tbody > tr:nth-child(1) > td:nth-child(2)",
												  "findAssert").text
		...
		driver.find_element_by_id("cDescription").send_keys(tool.randomStr(4,False,True,True))
		time.sleep(1)

		driver.find_element_by_id("bFansWizard").click()
		time.sleep(1)

		driver.find_element_by_id("cWizardDesc").send_keys(tool.randomStr(4,False,True,True))
		time.sleep(1)

		driver.find_element_by_id("bDisplayAwardNum").click()
		time.sleep(1)

		driver.find_element_by_id("cContact").send_keys(tool.randomStr(4,False,True,True))
		time.sleep(1)

		driver.find_element_by_id("cHint").send_keys(tool.randomStr(4,False,True,True))
		time.sleep(1)
