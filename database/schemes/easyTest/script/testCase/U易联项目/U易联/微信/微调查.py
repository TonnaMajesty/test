...
class EasyCase(TestCase):
	...
	def runTest(self):
		...
		driver.find_element_by_xpath('//a[@href="/Page/IA/SurveyList"]').click()
		time.sleep(5)
		# 查询验证
		...
		driver.find_element_by_id("cRequire").send_keys("123")
		time.sleep(1)

		driver.find_element_by_id("cEndThanks").send_keys("123123")
		time.sleep(1)

		driver.find_element_by_id("bCollectInfo").click()
		time.sleep(1)

		driver.find_element_by_id("cWizardDesc").click()
		time.sleep(1)
		...
		driver.find_element_by_id("surveyTitles_cTitle").send_keys("123")
		time.sleep(1)

		driver.find_element_by_id("surveyTitles_iCheckMax").click()
		time.sleep(1)

		driver.find_element_by_id("surveyTitles_cOptionA").send_keys("1")
		time.sleep(1)
		driver.find_element_by_id("surveyTitles_cOptionB").send_keys("2")
		time.sleep(1)
		driver.find_element_by_id("surveyTitles_cOptionC").send_keys("3")
		time.sleep(1)
		driver.find_element_by_id("surveyTitles_cOptionD").send_keys("4")
		time.sleep(1)
		driver.find_element_by_id("surveyTitles_cOptionE").send_keys("5")
		time.sleep(1)
		...
		# 查询
		driver.find_element_by_id("query_cKeyword").send_keys("mmm123")
		time.sleep(1)

		driver.find_element_by_id("query_cTitle").send_keys("mmm123")
		time.sleep(1)
