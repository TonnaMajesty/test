...
class EasyCase(TestCase):
	...
	def runTest(self):
		...
		driver.find_element_by_xpath('//*[@id="startDate"]').send_keys(u'2016-12-31 00:00:00')  # 开始时间输入“”
		...
		driver.find_element_by_xpath('/html/body/div/div[1]/div[2]/div[2]/div[1]/div[6]/div/div[1]/label/input').click()  # 选择整单促销
		driver.find_element_by_xpath('/html/body/div/div[1]/div[2]/div[2]/div[1]/div[6]/div/div[2]/label/input').click()  # 选择包邮活动
		driver.find_element_by_xpath('/html/body/div/div[1]/div[2]/div[2]/div[1]/div[6]/div/div[3]/label/input').click()  # 选择优惠券
		driver.find_element_by_xpath('/html/body/div/div[1]/div[2]/div[2]/div[1]/div[7]/div/div[1]/img').click()  # 点击主商品
		driver.find_element_by_xpath('//*[@id="ngdialog1"]/div[2]/div[1]/div[2]/div/div[2]/table/tbody[1]/tr/td[1]/span/input').click()  # 选择第一个商品
		driver.find_element_by_xpath('//*[@id="ngdialog1"]/div[2]/div[1]/div[2]/div/div[1]/div[8]/button').click()  # 点击添加
		driver.find_element_by_xpath('//*[@id="product"]/div[1]/div[1]/div[2]').click()  # 点击添加商品
		...
		self.assertNotEqual(QQ,EE,'删除成功')
