...
class EasyCase(TestCase):
	...
	def runTest(self):
		...
		driver.find_element_by_xpath('/html/body/div[1]/div/div[1]/ul[6]/li[2]/a').click();  # 点击企业信息
		...
		driver.find_element_by_xpath('/html/body/div[1]/div/div[2]/div/div[3]/div/div/div/div[1]/div/div/div[2]/div[1]/input').send_keys('E:\\tupian\\6666.png');  # 上传图片
