...
class EasyCase(TestCase):
	...
	def runTest(self):
		...
		ActionChains(driver).move_to_element(right_click).perform(1);  # 悬停于商品分类
		sleep(2)
		right_click = driver.find_element_by_xpath('//*[@id="category"]/ul/li[1]/a')
		ActionChains(driver).move_to_element(right_click).perform(1)  # 悬停于办公用纸
		sleep(2)
		...
		driver.find_element_by_xpath('//span[@data-code="FIRSTDELIVER"]').click()#点击货到付款
