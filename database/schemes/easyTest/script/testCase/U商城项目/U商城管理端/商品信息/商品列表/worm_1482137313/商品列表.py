...
class EasyCase(TestCase):
	...
	def runTest(self):
		...
		jc = driver.find_element_by_xpath('/html/body/div[1]/div/div[2]/div/form/div[1]/div[15]/div/input')
		jc.find_element_by_xpath('/html/body/div[1]/div/div[2]/div/form/div[1]/div[15]/div/select/option[2]').click()  # 选择计量单位
