...
class EasyCase(TestCase):
	...
	def runTest(self):
		...
		driver.find_element_by_xpath('//span[@data-status="O-920-175223-20161019-000009"]').click() # 点击第一行的订单号
		driver.back()
		...
		sleep(3)
		driver.find_element_by_link_text("R-920-175223-20161102-000001").click()#点击第一行的单号
