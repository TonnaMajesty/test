...
class EasyCase(TestCase):
	...
	def runTest(self):
		...
		driver.find_element_by_xpath('//*[@id="cart-list"]/div/div/div[2]/div[1]/div/div/div/div[1]/input').click()  # 勾选商品
		driver.find_element_by_xpath('//*[@id="cart-floatbar"]/div/div/div/div[2]/div[3]/div/div/div[1]/span').click()  # 点击去结算
		sleep(2)

		driver.find_element_by_xpath('//*[@id="navigation"]/ul/li[1]/a').click()#点击首页
		sleep(1)
		'''
		...
		sleep(2)
		driver.find_elements_by_xpath('//*[@class="settleMent"]')[0].click(1)  # 点击去结算
		sleep(3)