...
class EasyCase(TestCase):
	...
	def runTest(self):
		...
		driver.find_element_by_css_selector("#menuSider > li:nth-child(7) > div").click()  # 点击联系人
		sleep(3)
		driver.find_element_by_css_selector('#menuSider > li.col-sider-moren.current > ul > li > h4').click()  # 点击联系人列表
