...
class EasyCase(TestCase):
	...
	def runTest(self):
		...
		driver.find_element_by_css_selector('body > div:nth-child(7) > div > div.ant-modal-wrap > div > div.ant-modal-content > div.ant-modal-body > div > div.account-list > div > ul > li:nth-child(1) > div.check-trails-pop-gs > label > span.ant-checkbox > input[type="checkbox"]').click() #勾选
		driver.find_element_by_css_selector("body > div:nth-child(7) > div > div.ant-modal-wrap > div > div.ant-modal-content > div.ant-modal-footer > button:nth-child(2)").click() #确定
		...
		driver.find_element_by_css_selector('body > div:nth-child(8) > div > div.ant-modal-wrap > div > div.ant-modal-content > div.ant-modal-body > div > div > div.searchContent > span:nth-child(2) > span > input[type="text"]').send_keys(u"郑梓涛") #输入搜索
		driver.find_element_by_css_selector("body > div:nth-child(8) > div > div.ant-modal-wrap > div > div.ant-modal-content > div.ant-modal-body > div > div > div.searchContent > span:nth-child(2) > button").click() #点击搜索
		driver.find_element_by_css_selector('body > div:nth-child(8) > div > div.ant-modal-wrap > div > div.ant-modal-content > div.ant-modal-body > div > div > div.PopBox_OperateCnt > div.PopBox_selectResult > div.PopBox_selectPerson > ul > li > label > span > input[type="checkbox"]').click() #勾选
