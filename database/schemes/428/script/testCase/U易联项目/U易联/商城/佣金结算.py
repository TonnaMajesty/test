...
class EasyCase(TestCase):
	...
	def runTest(self):
		...
		time.sleep(1)
		# 订单完成时间
		driver.find_element_by_id("finishTime").send_keys("2016-03-16 10:31:55")
		time.sleep(1)
		# 分销商
		...
		driver.find_element_by_css_selector(
			"#orderList > div.k-header.k-grid-toolbar > a.k-button.k-button-icontext.k-grid-doSettlementAll").click()
		driver.switch_to_alert().accept()
		time.sleep(3)

		# 导出
		driver.find_element_by_css_selector(
			"#orderList > div.k-header.k-grid-toolbar > a.k-button.k-button-icontext.k-grid-excel").click()
		time.sleep(5)
