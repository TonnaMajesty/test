...
class EasyCase(TestCase):
	...
	def runTest(self):
		...
		driver.find_element_by_id("cCode").send_keys("123111")
		time.sleep(1)
		driver.find_element_by_id("cName").send_keys("123111")
		time.sleep(1)
		driver.find_element_by_id("cUrl").send_keys("www.baidu.com")
		time.sleep(1)
		driver.find_element_by_id("cDes").send_keys("123111")
		time.sleep(1)
		...
		self.assertEqual(new, '123111', '新增失败')

		time.sleep(2)
		driver.find_element_by_xpath('//a[@href="/Page/SR/QyEShopList"]').click()
		...
		time.sleep(1)
		driver.find_element_by_id("cUrl").clear()
		driver.find_element_by_id("cUrl").send_keys("www.baidu.com")
		time.sleep(1)
		...
		self.assertEqual(delete, "333", "删除成功")