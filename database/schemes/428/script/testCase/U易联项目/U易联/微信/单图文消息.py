...
class EasyCase(TestCase):
	...
	def runTest(self):
		...
		driver.find_element_by_css_selector(
			"#datalist > div:nth-child(1) > div.row_list.mr10.pd10 > div.row_list_icon > span > i.icon-link").click()
		time.sleep(1)

		# 首次关注
		driver.find_element_by_css_selector(
			"#datalist > div:nth-child(1) > div.row_list.mr10.pd10 > div.row_list_icon > span > i:nth-child(3)").click()
		...
		# 编辑
		driver.find_element_by_css_selector(
			"#datalist > div:nth-child(1) > div.row_list.mr10.pd10 > div.row_list_icon > span > i:nth-child(5)").click()
		time.sleep(1)
		...
		self.assertEqual(new, '关键词：'+s1, '新增失败')

		# 删除
		#driver.find_element_by_css_selector("#datalist > div:nth-child(1) > div.row_list.mr10.pd10 > div.row_list_icon > span > i.icon-delete").click()
		#driver.find_element_by_id("btnDialogBySHFConfirm").click()
		#time.sleep(1)
		# 删除验证
		#delete = driver.find_element_by_css_selector("#datalist > div:nth-child(1) > div.imgkeywords > span","findAssert").text
		#self.assertEqual(delete, s1, "删除成功")
