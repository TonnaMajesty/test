...
class EasyCase(TestCase):
	...
	def runTest(self):
		...
		time.sleep(3)
		driver.find_element_by_css_selector("#page_menu > li:nth-child(4) > div.typ > a:nth-child(5) > p").click()
		time.sleep(10)
		...
		xxlx = driver.find_element_by_css_selector(
			"#selArea > table > tbody > tr:nth-child(2) > td:nth-child(4) > span")
		xxlx.find_element_by_css_selector(
		...
		# 图文详情1
		driver.find_element_by_css_selector("#messageAnalysisGrid > div.k-header.k-grid-toolbar > a").click()
		time.sleep(3)
		time.sleep(5)